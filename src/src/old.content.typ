...
// - apply-parent-layers (boolean): Apply the outermost layers to the component, defaults to `false`.
//                                  This is useful to apply the outermost layer somewhere else if it
